...
def getArrayBasedOnFileNumber(fileNumber):
    fileTypeArray = ["flexBend1Averages", "flexBend2Averages", "flexBend3Averages", "flexBend4Averages", "flexBend5Averages", "pitchAverages", "rollAverages", "yawAverages", "accelXAverages", "accelYAverages", "accelZAverages"]
